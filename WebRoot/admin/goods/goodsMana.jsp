...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function dingcaiMana(goodsId)
           {
                   window.location.href="<%=path %>/dingcaiMana.action?goodsId="+goodsId;
           }
	...
	<body leftmargin="2" topmargin="2">
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="9">${sessionScope.jiudianmingcheng}</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<input type="button" value="查看定菜信息" onclick="dingcaiMana(<s:property value="#goods.goodsId"/>)"/>
					</td>
				</tr>
				</s:iterator>
			</table>
