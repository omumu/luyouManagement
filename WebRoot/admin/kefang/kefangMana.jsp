...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
		   ...
		   function yudingMana(kefangId)
           {
                var url="<%=path %>/yudingMana.action?kefangId="+kefangId;
                window.location.href=url;
           }
       </script>
	</head>
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="24" background="<%=path %>/img/tbg.gif">${sessionScope.binguanmingcheng}</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td  bgcolor="#FFFFFF" align="center" >
						<input type="button" value="查看预定信息" onclick="yudingMana(${kefang.id})"/>
