...
public class TToupiaoDAO extends HibernateDaoSupport {
	...
	public int getTPCount(){
		log.debug("统计投票数量");
		try {
			String hql = "select count(*) from t_toupiao";
	...
	public Integer getCountByAcidAndUserId(java.lang.Integer acid, java.lang.Integer userid)
	{
		log.debug("getCount");
		try
		{
			String QueryString = "find TToupiao where acid="+ acid +"and userid=?";
			List results = getHibernateTemplate().find(QueryString,userid);
